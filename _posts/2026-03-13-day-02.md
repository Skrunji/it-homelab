...
I started my own github page to show my repo in a little more polished format. In order to make this scalable rather than manually linking future journal entries myself, I'll be installing Ruby and Jekyll to manage that for me.
