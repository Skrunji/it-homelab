---
layout: post
title: "Day 02 - Continued Environment Setup"
date: 2026-03-13
---
...
```
I then exported it to a CSV. 

I started my own github page to show my repo in a little more polished format. In order to make this scalable rather than manually linking future journal entries myself, I'll be installing Ruby and 
Jekyll to manage that for me.

That's all for today! I feel pretty good about today.

Lessons learned:
- Understanding how GROUP BY interacts with aggregation functions
